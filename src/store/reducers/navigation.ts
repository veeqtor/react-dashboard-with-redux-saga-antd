...
const getNavigationState = (state: IApplicationRootState): ContainerState => state.navigation;
export const selectNavigationState = createSelector(getNavigationState, (data: Record<string, any>) => {
  return data;
});
